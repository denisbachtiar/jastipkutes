...
<a class="navbar-brand" href="#"><img src="{{ asset('img/logo_main.png')}}" height="35" alt=""></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <form class="form-inline my-2 my-lg-0">
                <input class="form-control mr-sm-2" type="search" placeholder="Cari produk atau toko" aria-label="Search">
              </form>
